...
def _load_local_model_config(model_name: str) -> Optional[Dict[str, Any]]:
...
def is_qwen_vl_model(model_name: str) -> bool:
    ...
    """
    if resolve_model_family(model_name) is ModelFamily.QWEN_VL:
        return True
...
def is_kimi_k25_model(model_name: str) -> bool:
    ...
    if "kimi-k2.5" in lowered_name or "kimi--k2.5" in lowered_name:
        return True
